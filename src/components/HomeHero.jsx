...
export default function HomeHero({ currentUser, whole, decimals, badge }) {
    ...
    <div style={{ background: '#4F46E5', height: 400 }} className="shrink-0 flex flex-col">
      <div className="flex items-center gap-2.5 px-5 pt-5">
        ...
        <div className="flex flex-col gap-1 flex-1 min-w-0">
          ...
          <span style={{ fontSize: 8, color: '#E2E8F0' }}>Your Split at glance</span>
        </div>
        <button
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-5" style={{ gap: 6 }}>
        <span className="text-white font-semibold text-center" style={{ fontSize: 16 }}>Main - RUP</span>
        <span className="text-white font-semibold text-center" style={{ fontSize: 51, lineHeight: 1 }}>
          {whole}.<span style={{ fontSize: 24 }}>{decimals} ₹</span>
        </span>
        <div
