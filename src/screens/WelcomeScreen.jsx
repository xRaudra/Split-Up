  ...
  return (
    <div className="flex flex-col h-full px-4 pt-[150px] pb-5 fade-in overflow-y-auto hide-scrollbar" style={{ background: '#F8FAFC' }}>
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center gap-2.5 mt-16 px-4">
          <h1 className="text-[42px] font-medium leading-none" style={{ letterSpacing: '-0.05em' }}>
            <span style={{ color: '#4F46E5' }}>Split</span>{' '}
            <span style={{ color: '#3730A3' }}>Up</span>
          </h1>
