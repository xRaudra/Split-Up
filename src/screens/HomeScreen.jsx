...
import { currentUser, totalOwedToUser } from '../data/mockData';

export default function HomeScreen({ tabs, onNavigate }) {
  const owed = totalOwedToUser(tabs);
  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto hide-scrollbar screen-enter" style={{ background: '#F8FAFC' }}>
      <div className="px-5 pt-6 pb-2">
        ...
        <h1 className="text-[22px] font-bold text-[#111827] mt-0.5">Your split, at a glance</h1>
      </div>
